...
var fight = function(enemyName) {
    ...
    //if player choses to skip
        ...
        var confirmSkip = window.confirm('Are you sure you wanna be a POOOOOOOOOSE');

        //IF yes (true), leave fight
        if (confirmSkip) {
            window.alert(playerName + ' has chosen to be a POOOOOOSE' + playerName + ' had 2 dollars deducted from ' + playerMoney )
            //take away muuuunie
